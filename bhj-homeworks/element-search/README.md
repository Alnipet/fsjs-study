...
В чём проблема _document.getElementById_ ? В том, что для повторяющихся блоков
...
работы с DOM. Некоторые из статей написаны на ES5, используют _var_, но
